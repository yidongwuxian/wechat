...
<div class="mod-index">
    <div class="mod-index__block mod-index__block_auto-height">
        <div class="ui-page-width">
            <h3 class="mod-index__subtitle" style="color: #FFFFFF;margin: 50px 0;">请选择公众微信号</h3>
            <div class="mod-case">
                            ...
                            <ul style="width:<?php echo $listPage*960 ;?>px;float:left" class="mod-case__list js_case_imgs_list">
                                <?php if( ! empty($list)): ?>
                                    <?php foreach($list as $k=>$qychat): ?>
                                        <a href="/admin/login/selectwechat/we_id/<?php echo $qychat->id; ?>">
                                        <li data-case-id="<?php echo $k+1; ?>" class="mod-case__item">
                                            ...
                                            <i class="mod-case__icon mod-case__icon-case10"></i><p class="mod-case__item-text"><?php echo $qychat->title; ?></p>
                                        </li>
                                        </a>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            ...
                            <ul style="width:960px;float:left" class="mod-case__list">
                                <?php if( ! empty($list)): ?>
                                    <?php foreach($list as $k2=>$qychat2): ?>
                                        <?php if( $k2>2 )break; ?>
                                        <li data-case-id="<?php echo $k2+1; ?>" class="mod-case__item"><img alt="" src="https://res.wx.qq.com/mmocbiz/zh_CN/tmt/home/dist/img/mod-case/banner1_bb303fa2.jpg" class="mod-case__item-image"> <img src="https://res.wx.qq.com/mmocbiz/zh_CN/tmt/home/dist/img/mod-case/banner1-blur_d180b345.jpg" class="mod-case__item-image-cover"> <i class="mod-case__icon mod-case__icon-case1"></i><p class="mod-case__item-text"><?php echo $qychat2->title; ?></p>
                                        </li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </ul>
