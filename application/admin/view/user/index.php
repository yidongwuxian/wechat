    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="page-header align-right">
                <a class="btn btn-primary" href="/admin/user/add">添加管理员</a>
            </div><!-- /.page-header -->

            <div class="widget-box widget-color-blue2">

            <div class="widget-header">
                <h4 class="widget-title lighter smaller">管理员列表</h4>
            </div>
                        ...
                        <table id="simple-table" class="table table-striped table-bordered table-hover">
                            ...
                            <?php if( ! empty($list)): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $qychat->we_name; ?></td>
                                    <td class="hidden-480"><?php echo date('Y-m-d',$qychat->create_time); ?></td>
                                    <td class="hidden-480">
                                        <div class="hidden-sm hidden-xs btn-group">
                                            <a class="btn btn-xs btn-info" href="/admin/user/edit/id/<?php echo $qychat->id; ?>">
