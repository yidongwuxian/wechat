                                ...
                                <div class="clearfix">
                                    <select multiple="multiple" class="select2 tag-input-style" data-placeholder="选择公众号">
                                        <?php foreach($wechatData as $v): ?>
                                            <option value="<?php echo $v['id']?>" <?php if(in_array($v['id'],$hasWechatIds)){echo 'selected';};?> ><?php echo $v['title']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <input type="hidden" id="we_ids" name="we_ids" value="<?php echo implode(',',$hasWechatIds)?>">
                        </div>
